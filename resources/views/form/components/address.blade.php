@php
    ...
    } elseif($address_separate_type == App\Consts\CommonConst::ADDRESS_NON_SEPARATE)  {
        ...
        <div class="">
            ...
            @if($post_code_use_type)
                <div class="flex-start-center gap-2 mb-1">
                    <x-input-text name="zip21" id="zip21" class="w-20" :value="old('zip21')" placeholder='100'
                    onKeyUp="{{ $on_keyup }}" :error="$errors->get('zip21')"/>
                    <div class="px-1">-</div>
                    <x-input-text name="zip22" id="zip22" class="w-20" :value="old('zip22')" placeholder='0001'
                                 :error="$errors->get('zip22')" onKeyUp="{{ $on_keyup }}" />
                </div>
            ...
            @if($address_separate_type == App\Consts\CommonConst::ADDRESS_SEPARATE)
                <div class="flex-start-center gap-2 mb-1">
                    <x-input-text name="pref21" id="pref21" class="w-48" :value="old('pref21')" placeholder='東京都' :error="$errors->get('pref21')"/>
                    <x-input-text name="address21" id="address21" class="w-48" :value="old('address21')"
                ...
                <div>
                    <x-input-text name="street21" id="street21" class="w-full" :value="old('street21')"
                                  :error="$errors->get('street21')"
                                  placeholder='千代田1-1-1マンション101号室'/>
                </div>
            ...
            @else
                <x-input-text name="address" class="w-full" :value="old('address')"
                              ...
                              placeholder="東京都千代田区千代田1-1-1マンション101号室"/>
